...
var translations = {
	'ca': {
		'tr-load': 'Descarregueu el microprogramari Freifunk per al vostre dispositiu!',
		...
		'tr-factory-help': 'Les imatges Factory són per instal·lar Freifunk als dispositius per primera vegada. Usualment, això es fa a través de la interfície web del microprogramari original.',
		'tr-sysupgrade-help': 'Les imatges Sysupgrade són per instal·lar-les als dispositius que ja tenen Freifunk. La imatge es pot instal·lar a través de la interfície web o del terminal.',
	...
	'en': {
		...
		'tr-factory-help': 'Factory images are for flashing routers with Freifunk for the first time. Usually via the web interface of the original firmware.',
		'tr-sysupgrade-help': 'Sysupgrade images are for flashing routers that already run Freifunk. The image can be applied using the web interface or the terminal.',
	...
	'es': {
		...
		'tr-factory-help': 'Las imágenes de fábrica son para enrutadores intermitentes con Freifunk por primera vez. Generalmente a través de la interfaz web del firmware original.',
		'tr-sysupgrade-help': 'Las imágenes de Sysupgrade son para enrutadores intermitentes que ya ejecutan Freifunk. La imagen se puede aplicar utilizando la interfaz web o el terminal.',
	...
	'no': {
		...
		'tr-factory-help': 'Factory avbildningen er for å laste rutere med Freifunk første gang. Vanligvis via webgrensesnittet til den originale fastvaren.',
		'tr-sysupgrade-help': 'Sysupgrade avbildningen er for rutere som allerede benytter Freifunk. Avbildningen innstaleres gjennom webgrensesnittet eller terminalen.',
	...
	'de': {
		...
		'tr-sysupgrade-help': 'Sysupgrade Abbilder werden für Geräte verwendet, die bereits Freifunk laufen haben. Es ist möglich, existierende Einstellungen beizubehalten.',
	...
	'fr': {
		...
		'tr-factory-help': 'Les images Factory sont prévues pour flasher les routers avec Freifunk pour la première fois. Habituellement à partir de l\'interface web du firmware d\'origine.',
		'tr-sysupgrade-help': 'Les images Sysupgrade sont prévues pour flasher les routers fonctionnant déjà avec Freifunk. L\'image peut être installée à travers l\'interface web ou par le terminal.',
	...
	'it': {
		...
		'tr-factory-help': 'Factory Image sono usate per installare Freifunk su router per la prima volta. Di solito l\'immagine può essere applicata via l\'interfaccia web del firmware originale.',
		'tr-sysupgrade-help': 'Sysupgrade Image sono usate per flashare router in cui Freifunk è già installato. L\'immagine può essere applicata via interfaccia web o terminale.',
	...
	'pl': {
		...
		'tr-factory-help': 'Obraz factory używany jest do pierwszej instalacji Freifunk. Zwykle można go użyć wykorzystując interfejs graficzny oryginalnego oprogramowania.',
		'tr-sysupgrade-help': 'Obraz sysuprade używany jest do aktualizacji routerów z zainstalowanym już Freifunk. Obraz można użyć przez GUI lub konsolę.',
	...
	'tr': {
		...
		'tr-factory-help': 'Fabrika imajları, ilk kez Freifunk yüklenen cihazlar içindir. Genellikle orijinal ürün yazılımının web arayüzü üzerinden yüklenir.',
		'tr-sysupgrade-help': 'Sysupgrade imajları, zaten Freifunk kurulu cihazlar içindir. İmaj, web arayüzü veya terminal kullanılarak yüklenebilir.',
